 ...
 * @property {string} n - Zero-padded display index, e.g. "01".
 * @property {string} title
 * @property {string} signal - Key into the ServiceRail 3D signal geometry.
...
export const SERVICES = [
  ...
  },
  {
    ...
    title: 'SEO',
    signal: 'seo',
    desc: 'Search engine optimization that compounds — technical fixes, content that earns rankings, local SEO where it fits, and measurement that ties visibility to pipeline.',
  },
];
