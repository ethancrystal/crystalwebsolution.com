...
// https://cdsportswearusa.com/` -> 308 Location:
// https://www.cdsportswearusa.com/). Emitting apex URLs in canonicals,
...
export const SITE_ORIGIN = 'https://www.cdsportswearusa.com';
