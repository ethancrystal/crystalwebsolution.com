...
//
// Cost/timeline/scope-exclusion FAQ answers and deliverablesNote are
// NOTE-style but avoid that specific word — the
// SERVICE_PAGES banned-copy test (tests/marketing.test.mjs) forbids it.
// Confirm real figures with the studio before shipping; see the
...
const CONTENT = {
  web: {
    ...
    deliverablesNote:
      '[CONFIRM: concept/revision-round count included, the actual handoff format (e.g. Figma link vs. exported kit), and a real turnaround per deliverable if one can be quoted]',
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: '[CONFIRM: whether pricing is disclosed pre-contact or kept quote-only, and a typical turnaround range in business days/weeks for a standard engagement]',
      },
      {
        q: 'What’s not included?',
        a: '[CONFIRM: whether engagements are scoped in a written proposal, and how out-of-scope requests that surface mid-project are handled]',
      },
    ],
  ...
  development: {
    ...
    deliverablesNote:
      '[CONFIRM: concept/revision-round count included, the actual handoff format (e.g. a GitHub repo vs. a zipped repository of source), and a real turnaround per deliverable if one can be quoted]',
    process: [
  ...
  brand: {
    ...
    deliverablesNote:
      '[CONFIRM: concept/revision-round count included, the actual handoff format, and a real turnaround per deliverable if one can be quoted]',
    process: [
