...
const CONTENT = {
  ...
  brand: {
    ...
    metaDescription:
      'Brand identity design for companies that refuse to blend in — strategy, identity system, voice and guidelines that set you apart.',
    title: 'Branding',
  ...
  seo: {
    ...
    metaDescription:
      'SEO agency for brands — technical fixes, pillar pages and earned links, measured in inquiries. Remote, working with companies across the US.',
