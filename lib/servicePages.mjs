...
// `title` stays the homepage/index taxonomy label. `h1` is the single
// visible heading on /services/[slug]; `seoTitle` is the document title
// stem (root layout appends `| CD Sportswear INC`).
//
...
const CONTENT = {
  web: {
    ...
    metaDescription:
      'A custom web design studio for brands — sites designed with intent and craft so they earn the click and the close, not a template that looks like everyone else.',
    title: 'Web Design',
    ...
    introduction:
      'We design custom websites for brands as products, not brochures. Every layout, type scale, and interaction earns its place by moving a visitor toward understanding and action.',
    problem:
    ...
    relatedWorkSlugs: ['zeus-towing-services', 'style', 'crystal-web-solution'],
  ...
  development: {
    ...
    metaDescription:
      'Custom React and Next.js web development for internal tools and products your team can own and extend — architected to ship, not stall in hand-off limbo.',
    title: 'Development',
    ...
    introduction:
      'We build custom React and Next.js applications behind your business: dashboards, portals, internal tools, and customer-facing products. Engineering that ships and stays shippable.',
    problem:
    ...
    relatedWorkSlugs: ['tucker-trips', 'talk-to-my-lawyer', 'prestige-online-learning'],
  ...
  brand: {
    ...
    metaDescription:
      'A branding studio for companies that refuse to blend in — identity, voice, and guidelines that make prospects tell you apart from the next vendor.',
    title: 'Branding',
    ...
    relatedWorkSlugs: ['crystal-web-solution'],
  ...
  logo: {
    ...
    metaDescription:
      'Custom logo and brand system design — marks and rules that hold up at any size, age well, and read as seriously crafted, not templated.',
    title: 'Logo Design',
    ...
    introduction:
      'A custom logo is the smallest, most-repeated decision your brand makes. We design the mark and the system around it so it holds up across decks, profiles, and print.',
    problem:
  ...
  marketing: {
    ...
    metaDescription:
      'Digital marketing for brands that want spend tied to outcomes — measured, sharpened, and accountable to revenue, not vanity metrics.',
    ...
    relatedWorkSlugs: ['zeus-towing-services', 'talk-to-my-lawyer'],
  ...
  ai: {
    ...
    metaDescription:
      'An AI automation agency for business: we take the repetitive load off your plate so your team spends hours on judgment, not busywork.',
    title: 'AI Automation',
  ...
  // Service 09 — SEO / search engine optimization. Theme 4 pillar.
  // Ships as a lead-gen-first service page: quote-only pricing (NotIncluded in
  // schema), CTA to /contact, no published rate card. The service-offer vs
  // lead-gen-pillar question is a commercial decision for MJ; the page structure
  // and schema do not assume either answer.
  seo: {
    eyebrow: 'Service 09',
    seoTitle: 'SEO Agency — Search Engine Optimization',
    metaDescription:
      'An SEO agency for businesses that want organic search to compound — technical fixes, content that earns rankings, local SEO where it fits, and measurement that ties visibility to pipeline.',
    title: 'SEO',
    h1: 'Search engine optimization that compounds',
    hero:
      'SEO is not a switch you flip — it is the slow, compounding work of making a real business findable by the people already looking for what it sells. We handle the technical and strategic pieces that make that happen, and we are honest about what is realistic for your site.',
    introduction:
      'We approach SEO as a long-term channel: fix what blocks search engines, publish and optimize content that answers real queries, build local presence where it fits, and measure visibility and conversions honestly — not vanity metrics dressed up as results.',
    problem:
      'Most SEO conversations start with rankings and end with disappointment, because rankings are an output, not a lever. A site with crawl errors, thin pages, and no local presence will not rank well regardless of how many times the word "SEO" appears in a proposal.',
    scenario:
      'A business that once showed up for its core terms stops appearing there. Nobody changed one thing that caused it — technical debt accumulated, competitors published better answers, local signals drifted, and the site quietly fell out of favor with whoever was looking. The fix is not a single action. It is a set of corrections spread across technical, content, and authority work, prioritized by what actually moves the business.',
    capabilities: [
      'Technical SEO — crawlability, indexation, site speed, structure',
      'On-page SEO — content, headings, metadata, internal linking',
      'Keyword and content strategy — what to target and what to write',
      'Local SEO — Google Business Profile, citations, geo content where it fits',
      'SEO audits — prioritized findings with a real fix list',
      'Analytics and conversion tracking — what visibility is actually doing',
    ],
    capabilityDetails: [
      'We check whether search engines can crawl and index what they should, and fix what blocks them — broken redirects, blocked resources, thin or duplicate pages, slow render paths.',
      'We optimize the pages that should rank: clear headings, descriptive metadata, content that answers the query better than the current top result, and internal links that pass relevance to the right pages.',
      'We pick target terms based on what the business actually sells and what the data suggests is reachable — not the biggest volume term, and not a term that has no realistic path for this site.',
      'For businesses serving real locations, local search is often the highest-ROI SEO work available: Business Profile setup and optimization, local citations, and geo content where the business genuinely operates.',
      'An audit produces a prioritized list of what is wrong and what to fix first — not a hundred findings with no sense of which ones matter.',
      'We wire up tracking so the site owner can see what visibility is doing and what it is translating into — because "we rank higher" without knowing what that means for the business is not useful.',
    ],
    deliverables: [
      'Technical SEO audit with a prioritized fix list',
      'Keyword and content target list',
      'On-page SEO for priority pages',
      'Technical fixes and implementation',
      'Local SEO setup where it fits the business',
      'Analytics and conversion tracking configuration',
      'Monthly SEO performance readout',
    ],
    process: [
      'Discovery — current site, technical state, and competition',
      'Opportunity map — what is realistically targetable',
      'Technical audit — what is blocking search engines',
      'SEO implementation — fixes, content, optimization',
      'Measurement — visibility and conversion data',
      'Ongoing refinement — what the data says to adjust',
    ],
    processDetails: [
      'We start by understanding the actual site — what it offers, who it serves, its current technical health, and who is competing for the same searches — before naming any target.',
      'We separate realistic opportunities from aspirational ones, because chasing terms the site cannot currently win wastes time and money better spent on terms it can.',
      'The technical audit identifies what is actively blocking crawlability, indexation, or performance — the things that suppress visibility regardless of how good the content is.',
      'Implementation covers technical fixes, on-page optimization for priority pages, and content work tied to the target list — not a scatter of changes with no shared purpose.',
      'We measure what is actually happening: visibility in search, traffic to the pages that matter, and whether that traffic is converting — not a wall of impressions that happened alongside a business outcome.',
      'SEO is ongoing by nature — we review what the measurement shows and adjust the next round of work accordingly, instead of treating day one as finished.',
    ],
    idealClient:
      'Businesses that understand SEO as a long-term compounding channel and want a real, honest partner to do the work — not a promise of a specific ranking in a specific month.',
    notIdealClient:
      'Not for you if you want overnight results, or if the expectation is that SEO alone will rescue a business model that does not have a product or service worth finding. SEO amplifies what is already real. It does not create it.',
    faq: [
      {
        q: 'How long does SEO take to work?',
        a: 'SEO is a long-term channel, not a quick fix. Technical fixes can be seen relatively quickly once search engines recrawl. Meaningful ranking movement for competitive terms usually takes months, not weeks. We will be honest about what is realistic for your site rather than sell you a false deadline.',
      },
      {
        q: 'Do you guarantee rankings?',
        a: 'No honest SEO provider can. Search engines decide rankings, and they change. We guarantee rigorous work against the factors we can influence — technical health, content quality, and authority — and we measure honestly whether that work is moving the needle.',
      },
      {
        q: 'What is the difference between SEO and digital marketing?',
        a: 'SEO is one channel within digital marketing, focused on organic search visibility. Digital marketing covers the broader set of channels — paid search, social, email, content — and how they work together. We treat them as connected pieces, not separate silos.',
      },
      {
        q: 'Do you do local SEO?',
        a: 'Yes. For businesses serving specific areas, local search is often the highest-ROI SEO work available. We handle Google Business Profile setup and optimization, local citations, and geo-targeted content where it genuinely fits the business.',
      },
      {
        q: 'What does SEO cost, and how long does it take?',
        a: 'Scope-dependent and quote-only — a technical audit is a different engagement from full ongoing SEO. Send your brief and website through Contact and you get a real scope and quote, not a guess.',
      },
      {
        q: 'What is not included?',
        a: 'Every engagement is scoped in a written proposal before work starts, so what is in and out is agreed up front. Ongoing content creation, paid ad management, and web development are separate services we can add to the scope if they fit.',
      },
    ],
    related: ['marketing', 'web', 'development'],
    // SEO outcomes are hard to showcase as before/after screenshots without invented
    // numbers. The honest related-work signal here is the studio itself — the site you
    // are on is a live, crawlable, well-structured example of the technical and content
    // discipline the SEO service sells. If MJ has a real client SEO result that can be
    // quoted without fabrication, swap this slug.
    relatedWorkSlugs: ['crystal-web-solution'],
    finalCta: 'Ready to make your business findable by the people already looking? Send the brief.',
  },
};
