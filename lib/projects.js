...
export const PROJECTS = [
  ...
  },
  {
    ...
    category: 'Web & app development',
    seoTitle: 'Web & App Development | Crystal Web Solution',
    seoDetail: 'The learning experience is the product. This project focused on making course discovery, progress tracking, and the student path easier to understand across the platform.',
  ...
  },
  {
    ...
    seoTitle: 'Immersive Web Experience | Crystal Web Solution',
    seoDetail: 'The catalog is only the starting point. This project focused on a more curated browsing experience, giving the collection a clearer visual rhythm and a more intentional path from discovery to product detail.',
