...
export const PROJECTS = [
  ...
  },
  {
    ...
    body: [
      'A conventional agency page could list the right capabilities and still feel interchangeable. CD Sportswear USA needed a site whose behavior made the case before the copy did.',
