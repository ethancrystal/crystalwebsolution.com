...
//
// client/year/results are scope facts, not performance claims — placeholder
// values pending real client-provided numbers; edit freely once available.
export const PROJECTS = [
  ...
  },
  {
    ...
    category: 'Web & app development',
    client: 'Talk to My Lawyer',
    year: '2023',
    results: [
      { value: '5', label: 'Step guided flow' },
      { value: '0', label: 'Consultations required to start' },
      { value: '1', label: 'Formatted output, ready to send' },
    ],
  ...
  },
  {
    ...
    results: [
      ...
      { value: '4', label: 'Rebuilt product templates' },
      { value: 'Mobile', label: 'First browse & checkout' },
    ],
  ...
  },
  {
    ...
    category: 'Web design',
    client: 'Zeus Towing Services',
    year: '2023',
    results: [
      { value: '1', label: 'Tap-to-call primary CTA' },
      { value: 'Mobile', label: 'First rebuild' },
      { value: '24/7', label: 'Service area clarity' },
    ],
  ...
  },
  {
    ...
    category: 'Web & app development',
    client: 'Prestige Online Learning',
    year: '2023',
    results: [
      { value: '1', label: 'Unified learning path' },
      { value: '2', label: 'Weeks to launch' },
      { value: '1', label: 'Progress dashboard' },
    ],
  ...
  },
  {
    ...
    client: 'Crystal Web Solution',
    year: '2026',
    results: [
      { value: '1', label: 'Continuous WebGL space' },
      { value: '9', label: 'Camera-linked beats' },
      { value: '0', label: 'Static hero images' },
    ],
