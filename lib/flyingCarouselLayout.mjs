...
export const CARD_WIDTH = 2.0736;
export const CARD_HEIGHT = 1.44;
export const SETTLED_SCALE_BOOST = 1.18;

// Normalized against the complete pinned Motion reference beat.
...
// Mutates `out` when provided, so the R3F useFrame path can sample the orbit
