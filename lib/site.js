...
export const SITE = {
  ...
  // Square icon-only mark - kept separate from logoPath (the wide wordmark
  // lockup) because schema.org's Organization.logo / Google's Knowledge
  // Panel wants a near-square image, not a ~6:1 wide strip.
  iconPath: '/icon.png',
