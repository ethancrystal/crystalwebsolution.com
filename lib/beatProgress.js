...
export const BEAT_IDS = ['hero', 'about', 'services', 'approach', 'stories', 'mark', 'lab', 'portfolio', 'contact'];
...
// The lab and portfolio beats hold a sticky stage while their tall sections
...
export function measureBeats(limit) {
  ...
  beatProgress.hero = 0;
  measureStickyWindow(LAB_WINDOW, 'lab', limit, beatProgress.portfolio);
  measureStickyWindow(MOTION_WINDOW, 'portfolio', limit, beatProgress.contact);
