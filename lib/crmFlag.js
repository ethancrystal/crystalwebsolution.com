...
//
// Deliberately fails open (missing/unset => enabled) to match the default-on
// behavior described above. Normalized against case and surrounding
// whitespace so a value typed as "False", "FALSE", or " false " in Vercel's
