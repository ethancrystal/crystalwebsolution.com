-- 0030_transition_status_visibility_recipients.sql
--
-- Reconciled from PR #69's unmerged 0028 draft after production recorded
-- security migrations under the 0027/0028 numeric slots. The live ledger does
-- not contain a 0024 row, and production already has this function body; this
-- migration is a tracked no-op reconciliation for clean rebuilds.
--
