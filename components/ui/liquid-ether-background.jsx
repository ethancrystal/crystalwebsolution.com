...
// Adapted from React Bits' Liquid Ether background (reactbits.dev/backgrounds/
// liquid-ether, JS-CSS variant): a GPU fluid simulation (advection,
// divergence, Poisson pressure solve) driven by cursor force, rendered as raw
// THREE.RawShaderMaterial passes. Reuses this project's existing `three`
// dependency directly rather than going through R3F/Canvas, since it manages
// its own renderer, RAF loop, and resize/visibility observers standalone —
// it isn't part of Scene.jsx's shared camera/canvas.
  ...
  return (
    <div className="liquid-ether-bg" aria-hidden="true">
      ...
      <style jsx>{`
        ...
        .liquid-ether-bg :global(.liquid-ether-container) {
          width: 100%;
          height: 100%;
        }
