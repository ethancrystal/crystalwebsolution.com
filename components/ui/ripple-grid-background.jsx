...
// Adapted from React Bits' Ripple Grid background (reactbits.dev/backgrounds/
// ripple-grid, JS-CSS variant). A glowing grid rendered as a full-screen
// fragment shader via ogl; ripples emanate continuously from center and
  ...
  return (
    <div className="ripple-grid-bg" aria-hidden="true">
      ...
      <style jsx>{`
        ...
        .ripple-grid-bg :global(.ripple-grid-container) {
          width: 100%;
          height: 100%;
          position: relative;
          overflow: hidden;
