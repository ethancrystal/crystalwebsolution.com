...
// Converts a hex color string (e.g. "#c084fc") into an "H S% L%" space-separated
// triplet matching the format the glowColor prop expects (see buildBoxShadow/parseHSL above).
...
export default function BorderGlow({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="border-glow-glow-inner"
          style={{
            inset: `${glowRadius}px`,
