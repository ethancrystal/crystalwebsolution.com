---
name: remotion
description: Best practices for Remotion — frame-accurate video creation in React. Use when building or editing Remotion compositions, sequencing/timing, transitions, captions/subtitles, audio and voiceover, embedding videos/images/GIFs, fonts, Tailwind, calculate-metadata, or rendering React-based video.
metadata:
